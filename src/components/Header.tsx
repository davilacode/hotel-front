          ...
          <ul className="flex flex-row items-center gap-4">
            <li>
              <Link
                ...
                className='flex h-7 text-2xl items-center justify-center rounded-full px-4 text-center text-sm font-medium text-muted-foreground transition-colors hover:text-primary'
                >
                Hoteles
              </Link>
            </li>
